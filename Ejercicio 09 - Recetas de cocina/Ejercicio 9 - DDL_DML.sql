...
/* -------------------------------------------- DML II --------------------------------------- */
SELECT recetas.nombre as receta, categorias.nombre as categoria, GROUP_CONCAT(ingredientes.nombre SEPARATOR ', ') as ingredientes from recetas
INNER JOIN
    recetas_categoria ON recetas.id_receta = recetas_categoria.id_receta
INNER JOIN
    categorias ON recetas_categoria.id_categoria = categorias.id_categoria
INNER JOIN
    recetas_ingredientes ON recetas.id_receta = recetas_ingredientes.id_receta
INNER JOIN
    ingredientes ON recetas_ingredientes.id_ingrediente = ingredientes.id_ingrediente
group by receta, categoria;
