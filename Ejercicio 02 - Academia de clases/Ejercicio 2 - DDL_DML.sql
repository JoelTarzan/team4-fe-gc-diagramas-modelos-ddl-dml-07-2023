...
insert into alumnos (dni, nombre, direccion, telefono, edad, cif_empresa) values ('9f689b84', 'Maribel', 'Martinez', '9100329559', 31, 'b601b6ab');
insert into alumnos (dni, nombre, direccion, telefono, edad, cif_empresa) values ('410e4548', 'Laura', 'reyes', '7951919808', 27, '512747c9');
...
insert into notas (dni, codigo_curso, nota) values ('9f689b84', 8, 6.5);
insert into notas (dni, codigo_curso, nota) values ('410e4548', 8, 6.5);    
...
/* ------------------ DML II ----------------- */
SELECT concat( profesores.nombre, ' ', profesores.apellidos) as profesor , count(notas.dni) as num_alumnos_al_cargo from profesores 
inner join impartidos 
on profesores.dni = impartidos.dni_profesor
inner join notas 
on impartidos.codigo_curso = notas.codigo_curso
group by profesor;
