...
/* -------------------------------------------- DML II --------------------------------------- */
SELECT socios.nombre, socios.dni as socio_dni, prestamos.fecha_devolucion, articulos.nombre as articulos from socios
inner join prestamos on prestamos.codigo_socio = socios.codigo_socio 
inner join articulos on prestamos.id_prestamo = articulos.id_prestamo;
